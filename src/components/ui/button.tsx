  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.96]",
  {
    variants: {
      variant: {
        ...
        game: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-elevated rounded-3xl text-base font-bold",
        "game-correct": "bg-language text-primary-foreground shadow-elevated rounded-3xl text-base font-bold",
        "game-wrong": "bg-destructive text-destructive-foreground shadow-elevated rounded-3xl text-base font-bold",
      },
      size: {
